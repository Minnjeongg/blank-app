...
if uploaded_file:
    ...
    if 'precipitation' in df.columns:
        df['precipitation_minmax'] = MinMaxScaler().fit_transform(df[['precipitation']])
    ...
    with tab1:
        ...
        ax.set_title("요일별 수요량", fontsize=11, fontproperties=font_prop)
        ax.set_xticklabels(order, fontproperties=font_prop)
    ...
    with tab2:
        ...
        ax2.set_title("자치구별 수요량", fontsize=11, fontproperties=font_prop)
    ...
    with tab3:
        ...
        with col1:
            ...
            ax3.set_title("강수량 원본", fontsize=11, fontproperties=font_prop)
        ...
        with col2:
            ...
            ax4.set_title("강수량 정규화", fontsize=11, fontproperties=font_prop)
